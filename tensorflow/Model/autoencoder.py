...
class Autoencoder(object):
    ...
    # def init_model(self, input_size, batch_size, learn_rate=0.01):
    #     with tf.variable_scope(self.name) as vs:
    #         self.x_holder = tf.placeholder(dtype=float, shape=[input_size, batch_size])
    ...
    #     with tf.variable_scope(self.name) as vs:
    #         return self.sess.run(self.trainer, {self.x_holder:input})
